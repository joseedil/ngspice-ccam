...
union YYSTYPE
{
#line 45 "parse-bison.y" /* yacc.c:355  */
...
#line 193 "parse-bison.c" /* yacc.c:358  */
...
#line 96 "parse-bison.y" /* yacc.c:1429  */
{
    (yylval).num = 0.0;
    yylloc.start = yylloc.stop = NULL;
}

#line 1258 "parse-bison.c" /* yacc.c:1429  */
  yyvsp[0] = yylval;
  yylsp[0] = yylloc;
  goto yysetstate;
...
#line 163 "parse-bison.y" /* yacc.c:1906  */
